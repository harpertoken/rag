...
from rag.ui.tui import run_tui
...
@patch('sys.stdin.isatty', return_value=True)
@patch('rag.ui.tui.Prompt.ask', side_effect=['hello', 'exit'])
@patch('rag.ui.tui.Console.print')
@patch('rag.ui.tui.RAGEngine')
@patch('rag.ui.tui.Panel')  # Mock Panel for CI-safe test
